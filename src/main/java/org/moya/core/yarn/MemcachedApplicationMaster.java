...
public class MemcachedApplicationMaster {

  private static final Log LOG = LogFactory.getLog(MemcachedApplicationMaster.class);
  ...
  public static void main(String[] args) {
    ...
    try {
      MemcachedApplicationMaster appMaster = new MemcachedApplicationMaster();
  ...
  public MemcachedApplicationMaster() throws Exception {
...
//    shellCommand = cliParser.getOptionValue("shell_command");
    ...
    if (envs.containsKey(MConstants.DISTRIBUTEDSHELLSCRIPTLOCATION)) {
      shellScriptPath = envs.get(MConstants.DISTRIBUTEDSHELLSCRIPTLOCATION);

      if (envs.containsKey(MConstants.DISTRIBUTEDSHELLSCRIPTTIMESTAMP)) {
        shellScriptPathTimestamp = Long.valueOf(envs
            .get(MConstants.DISTRIBUTEDSHELLSCRIPTTIMESTAMP));
      }
      if (envs.containsKey(MConstants.DISTRIBUTEDSHELLSCRIPTLEN)) {
        shellScriptPathLen = Long.valueOf(envs
            .get(MConstants.DISTRIBUTEDSHELLSCRIPTLEN));
      }
  ...
  public boolean run() throws YarnException, IOException {
    ...
    try {
		CreateGroup.main(new String[]{"172.16.165.155:2181","moya"});
	} catch (Exception e) {
...
//      String pathSuffix = appName + "/" + appId.getId() + "/AppMaster.jar";	    
   ...
   //   FileStatus destStatus = fs.getFileStatus(dst);
      ...
      LOG.debug("DSConstants Jar: " + MConstants.DISTRIBUTEDSHELLSCRIPTLOCATION);
      LOG.debug("DSConstants Size: "+MConstants.DISTRIBUTEDSHELLSCRIPTTIMESTAMP);
      LOG.debug("DSConstants TimeStamp: "+MConstants.DISTRIBUTEDSHELLSCRIPTLEN);
...
//      vargs.add("2>" + ApplicationConstants.LOG_DIR_EXPANSION_VAR + "/stderr");
      ...
      vargs.add(Environment.JAVA_HOME.$() + "/bin/java -jar Runnable.jar"); //-jar /tmp/moya-core-RUNNABLE.jar
      //vargs.add("-Xmx128m");
      // Set class name 
